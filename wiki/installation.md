...
| **Hytale Server** | 2026.03.20+ | Required minimum version |
...
| :--- | :--- | :--- |
| **Plugin not loading** | Wrong folder or outdated server | Confirm JAR is in `Mods/` (not a subfolder). Verify server version is 2026.03.20 or later. |
